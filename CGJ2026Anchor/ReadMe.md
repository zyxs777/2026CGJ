...
手柄1 RB / 右肩键：蓝方召唤幻影球员；蓄力传球时按住 RB 可触发突进传球
手柄2 A：PVP 下红方抓球 / 蓄力 / 释放 / 确认红方天赋
手柄2 RB / 右肩键：PVP 下红方召唤幻影球员；蓄力传球时按住 RB 可触发突进传球
手柄1 左右摇杆：蓝方选择天赋
手柄2 左右摇杆：红方选择天赋
拥有变向控球天赋时，持球后左摇杆左右：改变足球绕行方向
PVE 下仍兼容任意手柄 A/RB 操作蓝方
```
...
如果手柄按键没有反应，运行时按 `F2` 打开输入调试面板，查看 New Input System 当前识别到的设备、A/RB 对应的 control 名称和按下状态。
...
| 幻影球员 | 1 | 己方传球后可按 Z/RB 在球所在位置生成幻影球员；每次进球后的新一轮最多使用 1 次。 |
...
| 突进传球 | 3 | 每层让每轮可使用次数 +1。蓄力传球时按住 Z/RB 再松开出球键，球员会先沿传球方向突进，足球停在原地，突进结束后再踢出。 |
...
获得“幻影球员”后，蓝方传球后可按 `Z/RB` 在球所在位置生成一个幻影球员。
